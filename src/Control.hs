...
control s ev = case ev of 
  ...
  T.VtyEvent (V.EvKey (V.KChar 'k') _)  -> Brick.continue (move up    s)
  T.VtyEvent (V.EvKey (V.KChar 'j') _)  -> Brick.continue (move down  s)
  T.VtyEvent (V.EvKey (V.KChar 'h') _)  -> Brick.continue (move left  s)
  T.VtyEvent (V.EvKey (V.KChar 'l')  _) -> Brick.continue (move right s)
